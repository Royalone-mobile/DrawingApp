...
import com.songu.shadow.drawing.fragments.ChatFragment.FromViewGruop;
import com.songu.shadow.drawing.fragments.ChatFragment.ReadMesasgeTask;
import com.songu.shadow.drawing.fragments.ChatFragment.ToViewGroup;
...
public class ActivityChat  extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.layoutActionbar = (LinearLayout) findViewById(R.id.layoutChatActionbar);
        this.txtTitle = (TextView) this.findViewById(R.id.txtChatTitle);
        this.btnBack = (ImageView) this.findViewById(R.id.imgChatBack);
	...
	public void initControl()
	{
        ...
        layoutMessage = (LinearLayout) this.findViewById(R.id.layout_message_content);
        scrollMessage = (ScrollView) this.findViewById(R.id.scroll_message_content);
        editTextInput = (EditText) this.findViewById(R.id.editInputText);
    ...
    public static void onFail(ActivityChat activity,int memberId)  //If Read Message Fail
    {
        
    }
    public static void onSuccessRead(ActivityChat activity,String jsonArray,int memberId) //Read Message From Server
    {//Parsing        
    ...
    public void onClick(View v) {
        ...
        else if (v.getId() == R.id.imgChatBack)
        {
        	this.finish();
        }
    }
